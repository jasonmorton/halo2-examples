...
impl<F: FieldExt, const RANGE: usize> MyConfig<F, RANGE> {}
...
impl<F: FieldExt, const RANGE: usize> MyCircuit<F, RANGE> {}

// Your Circuit plays several roles and  will be passed to prover and verifier key generation, prover, and verifier.
